...
export default function Home() {
  ...
  return (
    <div className="bg-primary-light/10 w-screen min-h-lvh flex items-center justify-center grid grid-cols-2">
      ...
      <div className="col-span-1 flex flex-col items-center justify-center px-12 bg-white z-10 h-full w-full">
        <img src="/assets/images/brain-box-icon.png" alt="Brain Box" className="w-36 h-36 mb-4 -mt-32" />
        {
          mode === "login" ? (
            <div className="w-1/2">
